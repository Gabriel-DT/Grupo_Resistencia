function headerFooter (){
  ...
  document.getElementById("idheader").innerHTML =
    `
  <div class="logo">
    <!-- Después cambiar logo y agregar link al home o index-->
    <a href="#"><img src="img/logo.png" alt="Logo" width="400">
    </a>
  </div>
    <button id="boton-abierto" class="boton-abierto"><i class="fa-solid fa-bars"></i></button>
  ...
  <div class="social-media">
    <ul>
      <li>
        <!-- twitter -->
        <a href="#">
          <svg class="blur" viewBox="0 0 30 30">
